...
lc_2011 <- aggregate(lc_2011, fact = 5) #resampling rsater to 4000 x 4000 feet for fatser processing 
lc_2011 <- projectRaster(lc_2011, crs='ESRI:102604')

lc_2021 = raster('Data/lc_2021.tif')

lc_2021 <- aggregate(lc_2021, fact = 5) #resampling rsater to 4000 x 4000 feet for fatser
lc_2021 <- projectRaster(lc_2021, crs='ESRI:102604')
...
names(development_change) <- "lc_change"
ggplot() +
...
ggplot() +
  ...
  labs(title="Fishnet, 2500 Foot Resolution") +
  mapTheme
```
